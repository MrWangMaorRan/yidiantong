package com.yidiantong.model.impl.myhome;
...
public class MyHomeImpl {
    ...
    public void getUserInfo(Context mContext, Map<String, String> map,
                            MineImpl.OnCallBackListener onCallBackListener) {
...
//        });
        ...
        HttpUtil.okHttpGet(mContext, ApiConstants.userInfo, map, new CallBackUtil.CallBackString(mContext) {
            ...
            public void onFailure(Call call, Exception e) {
                LogUtils.i("MyhomeImpl", "MyhomeImpl userInfo onFailure --> " + e.getMessage());
            ...
            public void onResponse(String response) {
                try {
                    LogUtils.i("MyhomeImpl", "MyhomeImpl userInfo onResponse ---> " + response.toString());
...
//        });
        ...
        HttpUtil.okHttpPostFile_2(mContext, ApiConstants.uploadAvatar, file, fileKey, fileType, new CallBackUtil.CallBackString(mContext) {
            @Override
            public void onFailure(Call call, Exception e) {
                LogUtils.i("MyhomeImpl", "MyhomeImpl uploadAvatar onFailure --> " + e.getMessage());
            ...
            public void onResponse(String response) {
                try {
                    LogUtils.i("MyhomeImpl", "MyhomeImpl uploadAvatar onResponse ---> " + response.toString());
                    if (!StringUtils.isNullOrBlank(response)) {
                        ResponseBean responseBean = new Gson().fromJson(
                                response, new TypeToken<ResponseBean>() {
                                }.getType());
